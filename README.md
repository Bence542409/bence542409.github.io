...
<ul>
  <li><a href="php-googletimeline/">php-googletimeline</a></li>
  <li><a href="php-musicplayer/">php-musicplayer</a></li>
  ...
  <li><a href="web-database-system-txt/">web-database-system-txt</a></li> 
</ul>
